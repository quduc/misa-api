...
@section('content')
    ...
    <div class="card">
        ...
        {!! Form::open(['route' => [$routeList['confirm'],  null], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        <div class="card-body">
            <div class="admin-crud-form" id="admin-crud-form-create">
                @include ('admin.crud.parts.form')
            </div>
            <div class="row text-center mt-2">
                <div class="col-sm-12">
                    {!! Form::submit('戻る', ['name' => 'form_back','id' => 'admin-crud-form-btn-back', 'class' => 'btn btn-default btn-md p-3 mr-3']) !!}
                    {!! Form::submit('保存', ['name' => 'submit', 'id '=> 'admin-crud-form-btn-confirm', 'class' => 'btn btn-primary btn-md p-3']) !!}
                </div>
            </div>
        </div>
        {!! Form::close() !!}
