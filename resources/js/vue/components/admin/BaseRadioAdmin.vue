<template>
  <div :class="wrapClass">
    <div v-if="!!label" :class="wrapLabelClass">
      {{ label }}
    ...
    <div :class="wrapInputClass" class="py-1 px-3">
      <div :class="inputLocalClass" class="flex">
        <div v-for="(item, key) in items" :key="key" class="radio label py-1 mb-2 mr-2 px-2 d-inline-block align-items-center">
          <input :id="name + key" v-model="localValue" class="form-check-inline bg-white m-0" type="radio" :value="key" :disabled="disabled"/>
