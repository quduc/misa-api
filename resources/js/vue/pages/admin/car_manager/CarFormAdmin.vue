...
import CarFormStep1Admin from './CarFormStep1Admin'
import CarFormStep2Admin from './CarFormStep2Admin'
import CarFormStep3Admin from './CarFormStep3Admin'

export default {
  name: 'CarFormAdmin',
  components: { CarFormStep1Admin, CarFormStep2Admin, CarFormStep3Admin },
  provide() {
    return {
      getErrors: () => {
        return this.errors
  ...
  methods: {
    ...
    store(params) {
      ...
      this.$api
        ...
        .then(res => {
          ...
          setTimeout(function () {
            window.location = '/admin/cars/detail/' + res.data.id
          }, 500)
        })
        .catch(error => {
    ...
    update(params) {
      this.loading = true
      this.$api
        .updateCarAdmin(this.car.id, params)
        .then(res => {
